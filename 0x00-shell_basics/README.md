...
File 5-listfilesdigitonly displays current directory contents in long format, user and group IDs displayed numerically and hidden files.
...
File 12-file_type creates a script that prints the type of the file named iamafile.
...
File school.mgc is a magic file that can be used with the command, file to detect School data files.